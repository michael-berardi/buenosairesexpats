                ...
                <CardContent className="flex-grow">
                  <div className="space-y-3 mb-4">
                    ...
                    <div className="flex items-center gap-2 text-sm">
                      ...
                      <span>{visa.processing} processing</span>
                    </div>
                  </div>
                    ...
                    <tbody>
                      {comparisonFeatures.map((feature) => (
                        <tr key={feature.name} className="border-b last:border-0">
                          ...
                          <td className="py-3 px-2 text-sm text-muted-foreground">{feature.digitalNomad}</td>
                          <td className="py-3 px-2 text-sm text-muted-foreground">{feature.work}</td>
                          <td className="py-3 px-2 text-sm text-muted-foreground">{feature.retirement}</td>
                          <td className="py-3 px-2 text-sm text-muted-foreground">{feature.student}</td>
                          <td className="py-3 px-2 text-sm text-muted-foreground">{feature.investment}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-primary-foreground/80 mb-8">
              Immigration law is complex and changes frequently. We&apos;ve worked with a trusted 
              immigration partner who specializes in Argentine visas and has helped many of our readers.
            </p>
