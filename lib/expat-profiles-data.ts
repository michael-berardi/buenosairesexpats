...
export const expatProfilesBase: ExpatProfile[] = [
  ...
  
  {
    ...
    featured: true,
    seoDescription: "Erin from Sol Salute - 15+ years in Buenos Aires, helping expats settle in Argentina",
    hasScreenshot: true,
  },
  {
  ...
  },
  {
    ...
    yearsInBA: "3+ years",
    status: "active",
    bio: "Steph is a UK-born travel writer who has made Buenos Aires her base while exploring South America. Her guides cover everything from the cost of living to the best day trips from BA. She specializes in helping digital nomads and long-term travelers understand the practical realities of life in Argentina.",
