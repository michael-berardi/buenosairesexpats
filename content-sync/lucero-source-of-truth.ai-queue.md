...
- Queue items: 1
- Priorities: critical=0 high=1 medium=0
...
| --- | ---: | ---: | ---: | ---: |
| buenosairesexpats | 1 | 0 | 1 | 0 |

## Top Queue

| Site | Priority | Mode | Target | Reason | Runtime |
| --- | --- | --- | --- | --- | --- |
| buenosairesexpats | high | surface-sweep | countries | High-risk surface coverage is incomplete: reviewed=0/100, projected=5/100. | lib/nationality-data.ts |
